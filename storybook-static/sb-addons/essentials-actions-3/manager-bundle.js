    ...
    (() => {
        ...
        var Fa = __STORYBOOK_CORE_EVENTS__,
            {
                ...
                TESTING_MODULE_PROGRESS_REPORT: ko,
        ...
        function Tt(e) {
            ...
            return (
                (l *= 60),
                e.alpha !== void 0
                    ? { hue: l, saturation: p, lightness: s, alpha: e.alpha }
                    : { hue: l, saturation: p, lightness: s }
            );
        }
        function A(e) {
            return Tt(I(e));
        ...
        function It(e, t) {
            ...
            var r = A(t);
            return C(
                _({}, r, { lightness: D(0, 1, r.lightness - parseFloat(e)) })
            );
        }
        var gl = v(It);
        function Dt(e, t) {
            ...
            var r = A(t);
            return C(
                _({}, r, { saturation: D(0, 1, r.saturation - parseFloat(e)) })
            );
        }
        var hl = v(Dt);
        function Mt(e, t) {
        ...
        var $t = 'actions',
            ...
            Kt = (e, t) => {
                for (var r in t) ce(e, r, { get: t[r], enumerable: !0 });
            },
            Qt = (e, t, r, n) => {
            ...
            er = (e, t, r) => (
                ...
                Qt(
                    t || !e || !e.__esModule
                        ? ce(r, 'default', { value: e, enumerable: !0 })
                        : r,
                    e
                )
            ),
        ...
        var pe = ({ data: e }) => {
                ...
                if (
                    ...
                    return o.createElement(k, { object: r });
                if (Array.isArray(r)) {
                    let n = t.arrayMaxProperties,
                        a = r
                            .slice(0, n)
                            .map((s, l) =>
                                o.createElement(k, { key: l, object: s })
                            );
                    r.length > n &&
                        a.push(
                            o.createElement(
            ...
            dr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
                ...
                return o.createElement(
                    ...
                    typeof e == 'string'
                        ...
                        : o.createElement(pe, { data: e }),
                    o.createElement('span', null, ': '),
                    o.createElement(k, { object: n })
                );
            },
            fr = (e, t) =>
                function* (r) {
            ...
            mr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
                e === 0
                    ? o.createElement(cr, { name: t, data: r })
                    : o.createElement(dr, {
                          name: t,
                          data: r,
                          isNonenumerable: n,
        ...
        var Er = ({ rows: e, columns: t, rowsData: r }) => {
            ...
            Tr = ({ data: e, columns: t }) => {
                ...
                let { rowHeaders: c, colHeaders: f } = hr(e);
                t !== void 0 && (f = t);
                let d = c.map((m) => e[m]),
                    E;
                if (
                ...
                return o.createElement(
                    ...
                    o.createElement(Er, { rows: c, columns: f, rowsData: d })
                );
            },
            vr = fe(Tr),
            Sr = 80,
        ...
        var Br = B(lt)({ margin: 0, padding: '10px 5px 20px' }),
            ...
            zr = class extends Te {
                ...
                componentWillUnmount() {
                    this.mounted = !1;
                    let { api: e } = this.props;
                    (e.off(j, this.handleStoryChange),
                ...
                render() {
                    ...
                    return t ? o.createElement(kr, { ...r }) : null;
                }
            };
        function Ur() {
        ...
        Q.register(H, (e) => {
            Q.add(Yt, {
                ...
                type: De.PANEL,
                render: ({ active: t }) =>
                    o.createElement(zr, { api: e, active: !!t }),
                paramKey: $t,
            });
        });
    })();
