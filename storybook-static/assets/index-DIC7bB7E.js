            ...
            (function (r, o) {
                (function (s, p) {
                    ...
                    class u extends Error {
                        constructor(t) {
                            (super(
                                `The parsing ended early. The next token was: ${p(t)}`
                            ),
                                (this.token = t),
                    ...
                    class K {
                        static create(t) {
                            ...
                            return (
                                (t = a.text),
                                new K(t, void 0, n.token, a.token)
                            );
                        }
                        constructor(t, n, a, i) {
                            ((this.text = ''),
                    ...
                    function At({ allowTrailingComma: e }) {
                        return h({
                            ...
                            parseInfix: (t, n) => {
                                ...
                                do
                                    try {
                                        const i = t.parseIntermediateType(
                                            y.PARAMETER_LIST
                                        );
                                        a.push(re(i));
                                    } catch (i) {
                    ...
                    const xe = [
                        ...
                        j = [
                            ...xe,
                            H({ allowedTypes: ['event'], pathGrammar: xe }),
                        ];
                    function ie(e) {
                        let t;
                    ...
                    function ce({
                        ...
                        return h({
                            ...
                            parsePrefix: (i) => {
                                ...
                                if (i.consume(':'))
                                    g.returnType = i.parseType(y.PREFIX);
                                else if (!t)
                                    throw new Error(
                            ...
                            parsePrefix: (e) => {
                                ...
                                return e.consume('is')
                                    ? {
                                          ...
                                          left: t,
                                          right: P(
                                              e.parseIntermediateType(y.INFIX)
                                          ),
                                      }
                                    : {
...
function V(r) {
    ...
    return o == null
        ? ['', r]
        : [r.slice(0, o[0].length), r.slice(o[0].length)];
}
c(V, 'splitSpace');
function Ke(r) {
    return r.split(/\n/);
...
function Ce({ startLine: r = 0, markers: o = _ } = {}) {
    ...
    return c(function (d) {
        ...
        if (
            ((m.description = u),
            s.push({ number: p, source: d, tokens: m }),
            p++,
            T)
        ) {
            let J = s.slice();
    ...
    return c(function (o) {
        ...
        for (let d of r)
            if (
                ((p = d(p)),
                !(
                    (s = p.problems[p.problems.length - 1]) === null ||
                    s === void 0
                ) && s.critical)
            )
                break;
    ...
    return (s) => {
        ...
        for (let [T, [J, O]] of d.entries())
            ((J.type = O),
                ...
                ([J.postType, J.description] = V(
                    J.description.slice(O.length)
                )),
                u.push(J.type));
        return (
            (u[0] = u[0].slice(1)),
...
var wn = c((r, { tokens: o }, s) => (o.type === '' ? r : s), 'lineNo'),
    Pn = c(
        ({ tokens: r }) =>
            (r.delimiter === '' ? r.start : r.postDelimiter.slice(1)) +
            r.description,
        'getDescription'
    );
function Ze(r, o = _) {
