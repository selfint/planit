import{L as p}from"./LandingFeatureCard-0i66H1Iu.js";import{L as u}from"./LandingHero-C9LvJAbw.js";import{L as g}from"./LandingNav-CYCO5cOy.js";import{l as h}from"./logo-DOrqz8C6.js";const v=`<template>
...
`;function c(){const l=document.createElement("template");l.innerHTML=v;const d=l.content.firstElementChild;if(!(d instanceof HTMLTemplateElement))throw new Error("LandingPage template element not found");const a=d.content.firstElementChild?.cloneNode(!0);if(!(a instanceof HTMLElement))throw new Error("LandingPage template root not found");const o=a.querySelector("[data-landing-nav]");o!==null&&o.replaceWith(g());const s=a.querySelector("[data-landing-hero]");s!==null&&s.replaceWith(u());const m={plan:{label:"מתכנן סמסטר",title:"תכננו את ההרכבה",description:"גררו קורסים, בדקו עומס וראו תמונה מלאה של הסמסטרים.",href:"/plan",linkLabel:"מעבר למתכנן →",mediaAlt:"תצוגת מתכנן"},catalog:{label:"קטלוגים",title:"כל הדרישות במקום אחד",description:"בחרו מסלול, בדקו דרישות חובה ובחרו תמהיל מתאים.",href:"/catalog",linkLabel:"בדיקת קטלוגים →",mediaAlt:"תצוגת קטלוג"},search:{label:"חיפוש",title:"מצאו קורסים מהר",description:"חיפוש מתקדם עם פילטרים, דרישות קדם והצעות.",href:"/search",linkLabel:"לפתיחת חיפוש →",mediaAlt:"תצוגת חיפוש"},semester:{label:"סמסטרים",title:"מעקב לכל תקופה",description:"תיעוד עומסים, נקודות זכות, ושינויים בין סמסטרים.",href:"/semester",linkLabel:"מעבר לסמסטר →",mediaAlt:"תצוגת סמסטר"},course:{label:"פרטי קורס",title:"כל פרט במקום אחד",description:'תיאור, נק"ז, תנאי קדם וביקוש — בלי לעבור בין אתרים.',href:"/course",linkLabel:"לפרטי קורס →",mediaAlt:"תצוגת קורס"}};return a.querySelectorAll("[data-landing-feature-card]").forEach(e=>{const i=e.dataset.landingFeatureCard;if(i===void 0)return;const t=m[i],f=p({label:t.label,title:t.title,description:t.description,href:t.href,linkLabel:t.linkLabel,mediaAlt:t.mediaAlt});e.replaceWith(f)}),a.querySelectorAll('[data-placeholder="logo"]').forEach(e=>{e.src=h,e.loading="lazy",e.decoding="async"}),a.querySelectorAll("[data-feature-media], [data-hero-media]").forEach(e=>{e.dataset.videoReady="false"}),a}const w={title:"Pages/Landing",parameters:{layout:"fullscreen"}},n={render:()=>c(),globals:{theme:"light"}},r={render:()=>c(),globals:{theme:"dark"},parameters:{backgrounds:{default:"dark"}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => LandingPage(),
  globals: {
    theme: 'light'
  }
...
}`,...r.parameters?.docs?.source}}};const H=["Default","Dark"];export{r as Dark,n as Default,H as __namedExportsOrder,w as default};
