...
function Be() {
    ...
    return (
        ...
        Object.defineProperties(R, {
            ...
            hexToAnsi256: {
                value: (t) => R.rgbToAnsi256(...R.hexToRgb(t)),
                enumerable: !1,
            },
            ansi256ToAnsi: {
                value(t) {
            ...
            rgbToAnsi: {
                value: (t, n, i) => R.ansi256ToAnsi(R.rgbToAnsi256(t, n, i)),
                enumerable: !1,
            },
            hexToAnsi: {
                value: (t) => R.ansi256ToAnsi(R.hexToAnsi256(t)),
                enumerable: !1,
            },
        }),
        R
...
var xe = Object.defineProperties(() => {}, {
    ...
    Ge = (e, t) => {
        ...
        if (t.includes('\x1B'))
            for (; n !== void 0; )
                ((t = Fe(t, n.close, n.open)), (n = n.parent));
        let _ = t.indexOf(`
`);
        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
            for (let c of Ne(t))
                !Ke.call(e, c) &&
                    ...
                    Re(e, c, {
                        get: () => t[c],
                        enumerable: !(i = Ve(t, c)) || i.enumerable,
                    });
        return e;
    },
    Xe = (e, t, n) => (
            ...
            function _() {
                ...
                return (
                    ...
                    Object.defineProperties(u, {
                        ...
                        hexToAnsi256: {
                            value: (y) => u.rgbToAnsi256(...u.hexToRgb(y)),
                            enumerable: !1,
                        },
                    }),
                    u
                ...
                return (
                    Object.getOwnPropertySymbols &&
                        Object.getOwnPropertySymbols(p).forEach((o) => {
                            Object.getOwnPropertyDescriptor(p, o).enumerable &&
                                y.push(o);
                        }),
                    y
                );
            ...
            var u = (s) => s.constructor.name === 'NamedNodeMap',
                y = (s, l, a, d, g, E) => {
                    ...
                    return ++d > l.maxDepth
                        ...
                        : (l.min ? '' : O + n) +
                              (i.indexOf(O) !== -1
                                  ? `{${(0, t.printObjectProperties)(u(s) ? Array.from(s).reduce((A, w) => ((A[w.name] = w.value), A), {}) : { ...s }, l, a, d, g, E)}}`
            ...
            var t = ge(),
                ...
                y = (E) => {
                    let O = E.constructor.name,
                        ...
                        B = (typeof w == 'string' && w.includes('-')) || u(E);
                    return (
                        (A === n && (p.test(O) || B)) ||
                        (A === i && O === 'Text') ||
                        (A === c && O === 'Comment') ||
        ...
        'node_modules/pretty-format/build/plugins/Immutable.js'(e) {
            ...
            var t = oe(),
                ...
                g = (h, C, N, P, D, j, $) =>
                    ++P > C.maxDepth
                        ? l(s($))
                        : `${s($) + a}{${(0, t.printIteratorEntries)(h.entries(), C, N, P, D, j)}}`;
            function E(h) {
                let C = 0;
                return {
                    next() {
            ...
            var O = (h, C, N, P, D, j) => {
                    ...
                    return ++P > C.maxDepth
                        ? l($)
                        : `${$ + a}{${(0, t.printIteratorEntries)(E(h), C, N, P, D, j)}}`;
                },
                A = (h, C, N, P, D, j) => {
                    let $ = s('Seq');
                    return ++P > C.maxDepth
                        ? l($)
                        : h[c]
                          ? `${$ + a}{${h._iter || h._object ? (0, t.printIteratorEntries)(h.entries(), C, N, P, D, j) : d}}`
                          : `${$ + a}[${h._iter || h._array || h._collection || h._iterable ? (0, t.printIteratorValues)(h.values(), C, N, P, D, j) : d}]`;
                },
                w = (h, C, N, P, D, j, $) =>
                    ++P > C.maxDepth
                        ? l(s($))
                        : `${s($) + a}[${(0, t.printIteratorValues)(h.values(), C, N, P, D, j)}]`,
                B = (h, C, N, P, D, j) =>
                    h[_]
    ...
    at = F({
        'node_modules/react-is/cjs/react-is.development.js'(e) {
            (function () {
                ...
                function le(f) {
                    return (
                        typeof f == 'object' && f !== null && f.$$typeof === t
                    );
                }
                function se(f) {
                    return L(f) === o;
        ...
        'node_modules/pretty-format/build/index.js'(e) {
            ...
            function P(r, b, T, M, S, f) {
                ...
                return U === '[object Arguments]'
                    ? v
                        ? '[Arguments]'
                        : `${I ? '' : 'Arguments '}[${(0, n.printListItems)(r, b, T, M, S, z)}]`
                    : B(U)
                      ? v
                          ? `[${r.constructor.name}]`
                          : `${I || (!b.printBasicPrototype && r.constructor.name === 'Array') ? '' : `${r.constructor.name} `}[${(0, n.printListItems)(r, b, T, M, S, z)}]`
                      : U === '[object Map]'
                        ? v
                            ? '[Map]'
                        ...
                        : U === '[object Set]'
                          ...
                          : v || E(r)
                            ? `[${g(r)}]`
                            : `${I || (!b.printBasicPrototype && g(r) === 'Object') ? '' : `${g(r)} `}{${(0, n.printObjectProperties)(r, b, T, M, S, z)}}`;
            }
            function D(r) {
                return r.serialize != null;
            }
            function j(r, b, T, M, S, f) {
                let v;
                try {
                    v = D(r)
...
${U}`
            ...
            function z(r, b, T, M, S, f) {
                let v = $(b.plugins, r);
                if (v !== null) return j(v, r, b, T, M, S);
                let I = N(
                    r,
                    b.printFunctionName,
                    b.escapeRegex,
            ...
            var ee = (r) =>
                ...
                le = (r) => {
                    ...
                    return {
                        ...
                        plugins:
                            (v = r?.plugins) !== null && v !== void 0
                                ? v
                                : k.plugins,
                        printBasicPrototype:
                            (I = r?.printBasicPrototype) !== null &&
                            I !== void 0
                                ? I
                                : !0,
...
`,
            ...
            function ae(r, b) {
                if (b && (Q(b), b.plugins)) {
                    let M = $(b.plugins, r);
                    if (M !== null) return j(M, r, le(b), '', 0, []);
                }
                let T = N(r, te(b), re(b), ne(b));
                return T !== null ? T : P(r, le(b), '', 0, []);
            }
            var ce = {
